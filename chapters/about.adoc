...
*Alejandro Santamaría* es un desarrollador de software y líder técnico con mucha experiencia tanto en start-ups, empresas tradicionales, consultorías e incluso gobierno.
